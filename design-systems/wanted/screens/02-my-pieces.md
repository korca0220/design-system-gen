...
│   ├── Section: SearchBar
│   │   └── Slot: searchInput
│   │       ↳ component: design-systems/wanted/components/02-text-field.md
│   └── Section: MonthFilter
│       └── (반복) Item × N
...
**Slot: searchInput**
- ref: `design-systems/wanted/components/02-text-field.md`
...
- ref: `design-systems/wanted/components/04-chip.md`
- variant: `solid`
- size: `medium`
- bindings (per item):
