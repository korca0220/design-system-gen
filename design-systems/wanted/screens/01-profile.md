...
│   │   ├── Slot: avatar
│   │   │   ↳ component: design-systems/wanted/components/15-avatar.md
│   │   ├── Slot: name
│   │   │   ↳ component: design-systems/wanted/components/16-label.md
│   │   ├── Slot: email
│   │   │   ↳ component: design-systems/wanted/components/16-label.md
...
**Slot: title**
- ref: `design-systems/wanted/components/16-label.md`
...
**Slot: avatar**
- ref: `design-systems/wanted/components/15-avatar.md`
- variant: `person`
- size: `xlarge` (~80px)
- src: `{{user.avatarUrl}}`
- alt: `{{user.name}}`
...
**Slot: divider**
- ref: `design-systems/wanted/components/17-divider.md`
